...
import { Eye, Users, MousePointer, FileText, Search } from "lucide-react";
...
const AdminAnalytics = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const [sessionsRes, eventsRes] = await Promise.all([
        supabase.from('tracking_sessions').select('session_id'),
  ...
  // Calculate totals for each type from events
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-foreground mb-6">Session Analytics</h1>
